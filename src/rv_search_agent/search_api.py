...
DEMO_LISTINGS = [
    ...
    # Unity (Leisure Travel Vans) - Dealer listings
    RVListing(
        title="2024 Unity U24RL Rear Lounge",
        price=268000,
        year=2024,
        make="Unity",
        model="U24RL",
        location="San Diego, CA",
        url="https://example.com/listing/unity1",
        rv_type="Class B+",
        description="Rear lounge layout, Mercedes Sprinter 3500, dual A/C, 400W solar, lithium batteries, Girard awning.",
        source="Dealer",
    ),
    RVListing(
        title="2025 Unity U24RL Rear Lounge AWD",
        price=285000,
        year=2025,
        make="Unity",
        model="U24RL",
        location="Denver, CO",
        url="https://example.com/listing/unity2",
        rv_type="Class B+",
        description="Brand new 2025! AWD Mercedes Sprinter, rear lounge with 76\" sofa, European cabinetry, Corian counters.",
        source="Dealer",
    ),
    RVListing(
        title="2023 Unity U24RL - Certified Pre-Owned",
        price=235000,
        year=2023,
        make="Unity",
        model="U24RL",
        location="Phoenix, AZ",
        url="https://example.com/listing/unity3",
        rv_type="Class B+",
        description="CPO with extended warranty! 15K miles, rear lounge, Mercedes diesel, Onan generator, pristine condition.",
        source="Dealer",
    ),
    RVListing(
        title="2024 Unity U24TB Twin Bed",
        price=272000,
        year=2024,
        make="Unity",
        model="U24TB",
        location="Seattle, WA",
        url="https://example.com/listing/unity4",
        rv_type="Class B+",
        description="Twin bed layout, Mercedes Sprinter 3500, walk-around beds, great for couples, full bath.",
        source="Dealer",
    ),
    RVListing(
        title="2021 Unity U24RL Rear Lounge",
        price=195000,
        year=2021,
        make="Unity",
        model="U24RL",
        location="Portland, OR",
        url="https://example.com/listing/unity5",
        rv_type="Class B+",
        description="Well-maintained, 32K miles, new tires, just serviced at Mercedes. Rear lounge converts to bed.",
        source="Dealer",
    ),
    # Unity - Facebook Marketplace listings
    RVListing(
        title="2022 Unity U24RL Rear Lounge",
        price=215000,
        year=2022,
        make="Unity",
        model="U24RL",
        location="Austin, TX",
        url="https://facebook.com/marketplace/item/unity1",
        rv_type="Class B+",
        mileage=18000,
        description="Selling due to health. 18K miles, always garaged, full records. Rear lounge, lithium upgrade, 400W solar. Priced to sell!",
        source="Facebook Marketplace",
    ),
    RVListing(
        title="2023 Unity U24RL - Like New!",
        price=245000,
        year=2023,
        make="Unity",
        model="U24RL",
        location="Tampa, FL",
        url="https://facebook.com/marketplace/item/unity2",
        rv_type="Class B+",
        mileage=8500,
        description="Only 8.5K miles! Bought new, used for one trip. Rear lounge layout, Mercedes Sprinter 3500, all options. Warranty transfers!",
        source="Facebook Marketplace",
    ),
    RVListing(
        title="2024 Unity U24RL AWD",
        price=259000,
        year=2024,
        make="Unity",
        model="U24RL",
        location="Las Vegas, NV",
        url="https://facebook.com/marketplace/item/unity3",
        rv_type="Class B+",
        mileage=5200,
        description="AWD model! 5.2K miles, perfect condition. Rear lounge, dual A/C, 600W solar upgrade, Starlink installed. Moving abroad.",
        source="Facebook Marketplace",
    ),
    RVListing(
        title="2021 Unity U24RL",
        price=189000,
        year=2021,
        make="Unity",
        model="U24RL",
        location="Nashville, TN",
        url="https://facebook.com/marketplace/item/unity4",
        rv_type="Class B+",
        mileage=42000,
        description="Higher miles but meticulously maintained! All service at Mercedes dealer. Rear lounge, new batteries, new brakes. Great value!",
        source="Facebook Marketplace",
    ),
    # Other RV listings
    RVListing(
